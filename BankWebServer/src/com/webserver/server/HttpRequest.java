...
/**
 * Reference: https://github.com/ibogomolov/WebServer/blob/master/src/web/HttpRequest.java
 * 
 * Enhancement made by me: Modified the nested class HttpMethod to include methods POST, PUT and DELETE in addition to GET.
